...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="张一发儿"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="玉东园 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">张一发儿</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">138****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京 海淀区</div>
						<div class="adr-m" limit="30">玉东园 xxxxxxxxx</div>
